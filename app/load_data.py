...
cat0 = Categories(category_name='Basketball')
session.add(cat0)
session.commit()

cat1 = Categories(category_name='Soccer')
session.add(cat1)
session.commit()

cat2 = Categories(category_name='Baseball')
session.add(cat2)
session.commit()

cat3 = Categories(category_name='Hockey')
session.add(cat3)
session.commit()
